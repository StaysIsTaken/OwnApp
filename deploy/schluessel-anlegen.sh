...
if [ -f "$SCHLUESSELORT" ]; then
  ...
  echo ""
  echo "  Gleich wird ein Passwort abgefragt (zweimal). Merk es dir gut --"
  echo "  ohne das Passwort ist der Schluessel wertlos, und ohne den"
  echo "  Schluessel laesst sich die App auf keinem Geraet aktualisieren."
  echo ""
